...
from hacker_news_assets.resources.common_bucket_s3_pickle_io_manager import common_bucket_s3_pickle_io_manager
from hacker_news_assets.resources.duckdb_parquet_io_manager import duckdb_partitioned_parquet_io_manager
from hacker_news_assets.resources.hn_resource import hn_api_client, hn_api_subsample_client
from hacker_news_assets.resources.parquet_io_manager import (
...
RESOURCES_PROD = {
    "s3_bucket": ResourceDefinition.hardcoded_resource("dagster-hackernews-example-prod"),
...
RESOURCES_STAGING = {
    "s3_bucket": ResourceDefinition.hardcoded_resource("dagster-hackernews-example-dev"),
    "io_manager": common_bucket_s3_pickle_io_manager,
    "s3": s3_resource,
    "parquet_io_manager": s3_partitioned_parquet_io_manager,
