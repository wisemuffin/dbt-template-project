...
if __name__ == '__main__':
    deployment_name = os.environ.get("DAGSTER_DEPLOYMENT", "local")
    resource_defs = resource_defs_by_deployment_name[deployment_name]
    definitions = with_resources(definitions=all_assets, resource_defs=resource_defs, resource_config_by_key={})
    materialize(definitions, run_config={}, partition_key='2022-07-29-23:00')